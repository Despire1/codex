...
INSERT INTO "new_Homework" ("attachments", "createdAt", "deadline", "id", "isDone", "lastReminderAt", "status", "studentId", "takenAt", "takenByStudentId", "teacherId", "text", "updatedAt") SELECT "attachments", "createdAt", "deadline", "id", "isDone", "lastReminderAt", "status", "studentId", "takenAt", "takenByStudentId", "teacherId", "text", "updatedAt" FROM "Homework";
DROP TABLE "Homework";
