...
INSERT INTO "new_Homework" ("attachments", "createdAt", "deadline", "id", "isDone", "lastReminderAt", "status", "studentId", "takenAt", "takenByStudentId", "teacherId", "text", "updatedAt")
SELECT
  "attachments",
  "createdAt",
  "deadline",
  ...
  "lastReminderAt",
  CASE
    WHEN upper(coalesce("status", '')) = 'ACTIVE' THEN 'ASSIGNED'
    WHEN upper(coalesce("status", '')) = 'SENT' THEN 'ASSIGNED'
    WHEN upper(coalesce("status", '')) = 'NEW' THEN 'DRAFT'
