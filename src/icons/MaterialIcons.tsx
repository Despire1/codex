...
export const ChromeBrandIcon = (props: SVGProps<SVGSVGElement>) => (
  <svg viewBox="0 0 512 512" fill="currentColor" aria-hidden focusable="false" {...props}>
...
export const TelegramBrandIcon = (props: SVGProps<SVGSVGElement>) => (
...
export const AppleBrandIcon = (props: SVGProps<SVGSVGElement>) => (
...
export const AndroidBrandIcon = (props: SVGProps<SVGSVGElement>) => (
  <svg viewBox="0 0 576 512" fill="currentColor" aria-hidden focusable="false" {...props}>
